...
public class HomePresenter extends BasePresenter<HomeFragmentContract.View> implements HomeFragmentContract.Presenter {
    ...
    public void getArticles(int page, boolean isFresh) {
        if (mView != null) {
            ...
            HttpsUtil.request(HttpsUtil.createApi(App.getContext(), AppConfig.BASE_URL, ApiService.class).getHomeArticles(page), new HttpsUtil.IResponseListener<HomeArticlesBean>() {
                @Override
    ...
    public void getBanner() {
        ...
        if (mView != null) {
            ...
            HttpsUtil.request(HttpsUtil.createApi(App.getContext(), AppConfig.BASE_URL, ApiService.class).getBanner(), new HttpsUtil.IResponseListener<BannerBean>() {
                @Override
