...
/** 
 * DAO for table "COLLECTION_ARTICLES".
*/
public class CollectionArticlesDao extends AbstractDao<CollectionArticles, String> {

    public static final String TABLENAME = "COLLECTION_ARTICLES";

    /**
     * Properties of entity CollectionArticles.<br/>
    ...
    public CollectionArticlesDao(DaoConfig config) {
        super(config);
    }
    
    public CollectionArticlesDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"COLLECTION_ARTICLES\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"COLLECTION_ARTICLES\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, CollectionArticles entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, CollectionArticles entity) {
        stmt.clearBindings();
    ...
    @Override
    public CollectionArticles readEntity(Cursor cursor, int offset) {
        CollectionArticles entity = new CollectionArticles( //
    ...
    @Override
    public void readEntity(Cursor cursor, CollectionArticles entity, int offset) {
    ...
    @Override
    protected final String updateKeyAfterInsert(CollectionArticles entity, long rowId) {
        return entity.get_id();
    }
    
    @Override
    public String getKey(CollectionArticles entity) {
        if(entity != null) {
            return entity.get_id();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(CollectionArticles entity) {
